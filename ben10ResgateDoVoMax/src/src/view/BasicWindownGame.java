...
public class BasicWindownGame extends JFrame{
	...
	/*
	 * public void makeGrid(JPanel gridMap, Cell cells[][]) { for(int i=0;
	 * i<cells.lenght(); i++) { this.vector[i] = new JPanel(new
	 * GridLayout(1,cells.lenght())); this.vector[i].setPreferredSize(new
	 * Dimension(720, 52));
	 * 
	 * for(int j=0; j<cells.lenght[i](); j++) {
